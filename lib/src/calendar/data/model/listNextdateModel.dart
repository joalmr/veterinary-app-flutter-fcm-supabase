...
ListNextdateModel listNextdateModelFromJson(String str) => ListNextdateModel.fromJson(json.decode(str));

String listNextdateModelToJson(ListNextdateModel data) => json.encode(data.toJson());
