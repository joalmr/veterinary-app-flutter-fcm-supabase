...
AttentionRegModel attentionRegModelFromJson(String str) => AttentionRegModel.fromJson(json.decode(str));

String attentionRegModelToJson(AttentionRegModel data) => json.encode(data.toJson());
...
class AttentionRegModel {
    ...
    factory AttentionRegModel.fromJson(Map<String, dynamic> json) => AttentionRegModel(
        ...
        result: List<AttentionReg>.from(json["result"].map((x) => AttentionReg.fromJson(x))),
    );
