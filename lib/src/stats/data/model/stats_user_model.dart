...
StatsUserModel statsUserModelFromJson(String str) =>
    StatsUserModel.fromJson(json.decode(str));
...
class Result {
  ...
  factory Result.fromJson(Map<String, dynamic> json) => Result(
        usersMonth: List<UsersMonth>.from(
            json['users_month'].map((x) => UsersMonth.fromJson(x))),
      );
