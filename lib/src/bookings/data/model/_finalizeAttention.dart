...
//
//     final finalizeAttention = finalizeAttentionFromJson(jsonString);

import 'dart:convert';

FinalizeAttention finalizeAttentionFromJson(String str) => FinalizeAttention.fromJson(json.decode(str));

String finalizeAttentionToJson(FinalizeAttention data) => json.encode(data.toJson());
...
class FinalizeAttention {
    ...
    factory FinalizeAttention.fromJson(Map<String, dynamic> json) => FinalizeAttention(
        ...
        consultationNotificationNextdate: json["consultation_notification_nextdate"],
        consultationNotificationReason: json["consultation_notification_reason"],
        consultationNotificationObservation: json["consultation_notification_observation"],
        ...
        dewormingNotificationObservation: json["deworming_notification_observation"],
        ...
        groomingNotificationObservation: json["grooming_notification_observation"],
        vaccinationNotificationNextdate: json["vaccination_notification_nextdate"],
        vaccinationNotificationReason: json["vaccination_notification_reason"],
        vaccinationNotificationObservation: json["vaccination_notification_observation"],
    );
    ...
    Map<String, dynamic> toJson() => {
        ...
        "consultation_notification_observation": consultationNotificationObservation,
        ...
        "vaccination_notification_observation": vaccinationNotificationObservation,
    };
}
